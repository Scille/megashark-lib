  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <div id="container">
        ...
        <!-- responsive mixin -->
        <div class="example-divider">
          <ion-label class="title-h2">{{ $msTranslate('usage.responsive.mixin.title') }}</ion-label>
          <div class="example-divider-content">
        ...
        <!-- window width -->
        <div class="example-divider">
          <ion-label class="title-h2">{{ $msTranslate('usage.responsive.windowWidth.title') }}</ion-label>
          <div class="example-divider-content">
            <div class="example-data">
              <ion-label>
